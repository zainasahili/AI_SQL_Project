...
questions = [
    "Which airport has the most depratures?",
    "How many passengers flew between two specific cities in a date range",
    "What is the busiest time of day for departures",
    "How often are suitcases delayed or lost",
    "What's the average number of suitcases per passenger",
